  ...
  return (
    <Box>
      <Box sx={{ display: "flex", justifyContent: "flex-end", mb: 1 }}>
        <IconButton size="small" title="Ajouter un supplément" onClick={() => append({ description: "", pricePerPerson: "", totalPrice: "", currency: "EUR" })} sx={{ bgcolor: "success.light", color: "success.dark", width: 28, height: 28, "&:hover": { bgcolor: "success.main", color: "common.white" } }}>
